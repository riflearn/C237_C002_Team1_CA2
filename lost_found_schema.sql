...
CREATE TABLE items (
  ...
  status          ENUM('unclaimed', 'pending', 'claimed', 'removed') NOT NULL DEFAULT 'unclaimed', -- 'pending' = a claim was approved but the item hasn't been physically collected from the hub yet; set on claim approval, cleared by "Mark as collected"
